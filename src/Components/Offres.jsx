        ...
        <div className='flex lg:flex-row gap-5 justify-center items-center flex-wrap p-5'>
            ...
            hover:-translate-y-2 transition-all duration-500 ease-in-out'>
                <div className='flex justify-between items-center'>
                    ...
                    <p className='text-amber-50 font-bold lg:text-2xl'>1300 FCFA</p>
                </div>
            ...
            hover:-translate-y-2 transition-all duration-500 ease-in-out'>
                <div className='flex justify-between items-center'>
                    ...
                    <p className='text-amber-50 font-bold lg:text-2xl'>2500 FCFA</p>
                </div>
            ...
            hover:-translate-y-2 transition-all duration-500 ease-in-out'>
                <div className='flex justify-between items-center'>
                    ...
                    <p className='text-amber-50 font-bold lg:text-2xl sm:text-xl'>3500 FCFA</p>
                </div>
